...
client.execute(
    ...
    [
        (1, 1, 3, 100, 1), # Запрос 1: склад 1 → товар 3 (базовый штраф = 1)
        (2, 2, 2, 100, 2), # Запрос 2: склад 2 → товар 2 (базовый штраф = 2) ← УЖЕ ЕСТЬ НА СКЛАДЕ!
        (3, 3, 1, 100, 3)  # Запрос 3: склад 3 → товар 1 (базовый штраф = 3)
    ]
)
...
client.execute(
    ...
    [
        (1, 2, 1), # 1 → 2 (расстояние 1)
        (1, 3, 2), # 1 → 3 (расстояние 2)
        (2, 1, 1), # 2 → 1 (расстояние 1)
        (2, 3, 1), # 2 → 3 (расстояние 1)
        (3, 2, 1), # 3 → 2 (расстояние 1)
        (3, 1, 2), # 3 → 1 (расстояние 2)
    ]
)